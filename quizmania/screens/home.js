...
export default function Home(props) {
    return (
        <View style={{backgroundColor:'red',height:'100%'}}>
            ...
            <View>
                <ImageBackground style={{width:500,height:450, alignSelf:'center'}} 
                ...
                >
                    ...
                    <TouchableOpacity style={{alignItems:'center',marginTop:'60%',}} 
                        ...
                        <Text style={{backgroundColor:'#d00000',color:'white',fontSize:16,padding:20,paddingTop:5,paddingBottom:5,borderRadius:10}}>Start</Text>
                    </TouchableOpacity>
